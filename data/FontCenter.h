...
namespace FontSize
{
	static constexpr int SMALL = 12, MEDIUM = 24, LARGE = 36,HUGEE=48;
	static constexpr std::array<int, 4> list({
		FontSize::SMALL, FontSize::MEDIUM, FontSize::LARGE,FontSize::HUGEE
	});
};
